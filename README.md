...
### 👉 **服务协议**
   ...
   <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;YXminer受香港法律监管。请注意，不同国家/地区的法律要求可能会限制此类产品和服务。
...
### 👉 **Linux安装**
   ...
   ```sh
   <p>&emsp;&emsp;bash <(curl -s -L https://github.com/YXMINER/yxminer/raw/main/install.sh)</p>
   ```
...
### 👉 **Windows安装**
   ...
   ```sh
   <p>&emsp;&emsp;https://github.com/YXMINER/yxminer/tree/main/windows</p>
   ```
